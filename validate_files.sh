...
# Check if the file contains "// Code generated"
...
# Check if the copyright year is in the expected years
...
for file in $CHANGED_FILES; do
    ...
    # Check if file contains "// Code generated"
...
# If any files failed, list them by error type
